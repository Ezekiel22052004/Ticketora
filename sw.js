const CACHE_NAME = 'ticketora-v9-ticket-core';
const CORE = ['/', '/index.html', '/app.js', '/style.css', '/config.js', '/logo.png', '/ticket-template.png', '/manifest.json', '/icons/icon-192.png', '/icons/icon-512.png', '/icons/icon-maskable-512.png'];
